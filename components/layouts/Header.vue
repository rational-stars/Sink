    ...
    <nav class="container relative z-50 h-24 select-none">
      <div
        ...
        <div class="flex items-center justify-start w-1/4 h-full pr-4">
          <a href="/" class="flex items-center py-4 space-x-2 text-xl font-extrabold text-gray-900 md:py-0">
        ...
        <div
          ...
          :class="{ 'flex fixed': showMenu, 'hidden': !showMenu }" @touchmove.prevent>
          <div
            ...
            <div class="flex flex-col items-start justify-end w-full pt-4 md:items-center md:w-1/3 md:flex-row md:py-0">
              <a class="w-full px-6 py-2 mr-0 text-gray-700 cursor-pointer md:px-3 md:mr-2 lg:mr-3 md:w-auto"
